...
X 系列是目前覆盖最完整的产品系列,提供 **Android、iOS、桌面端(Camera SDK / Media SDK)** 三类原生 SDK,以及跨平台的 **OSC 协议**,可用于连接相机、参数设置、拍照录像、实时预览、文件管理、直播、固件升级,以及全景素材的拼接与导出。

## 文档集

| 文档集 | 状态 | 入口 |
| --- | --- | --- |
| Android SDK | ✅ 已支持 | [概述](./android/guide/) · [接口文档](./android/api/) |
...
X 系列各 SDK 总体覆盖:**X5、X4 Air、X4、X3、ONE X2、ONE X、ONE RS、ONE RS 一英寸**(各 SDK 略有差异,具体以对应文档集的「概述 / 接口文档」为准)。
